...
- (BOOL)displayWithViewController:(UIViewController * _Nonnull)viewController SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM(NSInteger, targetingResultStatus, closed) {
